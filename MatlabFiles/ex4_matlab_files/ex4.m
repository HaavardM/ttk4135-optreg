...
c = zeros(N*8, 1);                                  % Generate c, this is the linear constant term in the QP

%%
lamda_ref = zeros(6*N, 6*N);
lamda_ref(1:6:end, 1:6:end) = 0;

lambda_cost = zeros(N*6, N*6);
lambda_cost(1:6:end) = 1;
p_cost = eye(N*2);
